...
from auxiliary import log_function_call, read_instance, sorted_dir_list
...
def CNS_BP(n: int, c: int, weights: List[int], overall_time_limit: float = 60,seed: int = 1) -> Tuple[Solution, int]:
    random.seed(seed)
    """
